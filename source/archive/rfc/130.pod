...
Transaction-enabled variables for Raku
...
In raku, we can support transaction-enabled variables (including objects and
...
In this RFC we will look at how these variables would look like in raku.
