...
(tainting the C<RAKULIB> (?)  environment variable) might be allowed to
...
implement a denial of resources attack, using the raku own modules. The
...
This could be implemented either entirely within Raku, but this carries
