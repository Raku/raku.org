...
Assuming that lazy evaluation is used in other parts of Raku, it
...
supposed to be improved in Raku, this would be a reasonable way to do
it.

If other lazy evaluation mechanisms work in Raku, they could be used
instead.
