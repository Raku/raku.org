...
A version of Memoize.pm should be added into the Raku standard
...
There were no real objections to including memoize.pm in the Raku core.
...
Add memoize into the raku source tarball, as a pragmatic module.

The Raku language may allow some workarounds to be avoided, such
